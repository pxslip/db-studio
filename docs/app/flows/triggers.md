...
![Event Hooks](/images/event-hook-20220602A.webp)
...
- A request to create an item is sent to d9.
...
script operation or end the flow on a
...
![Webhook](/images/webhook-20220602A.webp)
...
![Schedule a Cron Job](/images/cron-20220602A.webp)
...
![Another Flow](/images/another-flow-20220602A.webp)
...
![A pane is open in front of a Flow. It shows various options detailed below.](/images/manual-input-settings-20230227A.webp)
...
- **Location** — Choose to display the button on the Item Page,
  Collection Page, or both.
...
After the operation runs, a toast notification will appear in your sidebar indicating
whether the flow ran successfully.

### Confirmation Dialog

![A modal is shown reading "Please provide alert information" with two text fields - one for text and one for content.](/images/manual-confirmation-dialog-20230227A.webp)
