...
> Insights is a Module in d9 that allows rapid, no-code build-out of analytics dashboards. Regardless of your
...
Dashboard view, edit, and create permissions are [fully configurable](/app/users-roles-permissions) by User
Role.
...
The Bar Chart Panel is only available in d9 Cloud and Enterprise Self-Hosted projects.
...
The Line Chart Panel is only available in d9 Cloud and Enterprise Self-Hosted projects.
...
The Meter Panel is only available in d9 Cloud and Enterprise Self-Hosted projects.
...
The Pie and Donut Chart Panels are only available in d9 Cloud and Enterprise Self-Hosted projects.
