...
loading your operation, this object is imported by the DB Studio App host.
...
your operation, this object is imported by the DB Studio API host.
...
The extension id needs to be identical for both entrypoints in order for DB Studio to recognize them as part of the same
extension.
