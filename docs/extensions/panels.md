---
description: A guide on how to build custom Panels in d9.
readTime: 3 min read
---
...
The panel component is the part of your extension that will be rendered by the d9 App whenever your panel should
