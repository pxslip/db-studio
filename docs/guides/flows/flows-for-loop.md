...
trigger flow operation to pass the data into an
another flow trigger. When this type of trigger receives an array as a
...
appended under the trigger flow operation in the starting flow.

Third, you could add another trigger flow operation into the
