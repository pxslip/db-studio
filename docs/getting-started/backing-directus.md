---
description: What you can do to support d9.
readTime: 3 min read
---

# Supporting d9

> d9 is fully open-source and free. It takes significant resources to maintain the platform. If you'd like to help
> keep development active, please consider supporting d9 through one of the methods below.

## Brand Advocacy

**You can create perfect software, but if no one knows about it, it's all for naught.**
...
**While the d9 Core Team spearheads development, community engagement is an essential part of the d9
mission. We need your help in order to make d9 all it can be.**
