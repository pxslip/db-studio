---
description: REST and GraphQL API documentation on the Utilities collection in d9.
readTime: 3 min read
...
Resets both the data and schema cache of d9. This endpoint is only available to admin users.
